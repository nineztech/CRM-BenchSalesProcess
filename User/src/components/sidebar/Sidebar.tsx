...
import { FaTachometerAlt, FaUserPlus, FaUsers, FaBuilding, FaChartLine } from 'react-icons/fa';
  ...
  return (
    ...
    >
      ...
      <ul className="mt-2 space-y-2">
        <SidebarItem icon={<FaUserPlus />} to="/leadcreation" text="Lead Creation" isExpanded={isExpanded} />
        
        <SidebarItem icon={<FaChartLine />} to="/sales" text="Sales" isExpanded={isExpanded} />
      </ul>
    </div>
  );
};
