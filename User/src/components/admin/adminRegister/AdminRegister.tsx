              ...
              {isLoading ? (
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse">
                    <thead>
                      <tr>
                        <th className=" p-1.5 text-start text-xs font-medium text-gray-600 bg-gray-50 border-b border-gray-200  whitespace-nowrap">#</th>
                        <th className=" p-1.5 text-start text-xs font-medium text-gray-600 bg-gray-50 border-b border-gray-200  whitespace-nowrap">First Name</th>
                        <th className=" p-1.5 text-start text-xs font-medium text-gray-600 bg-gray-50 border-b border-gray-200  whitespace-nowrap">Last Name</th>
                        <th className=" p-1.5 text-start text-xs font-medium text-gray-600 bg-gray-50 border-b border-gray-200  whitespace-nowrap">Mobile</th>
                        <th className=" p-1.5 text-start text-xs font-medium text-gray-600 bg-gray-50 border-b border-gray-200  whitespace-nowrap">Username</th>
                        <th className=" p-1.5 text-start text-xs font-medium text-gray-600 bg-gray-50 border-b border-gray-200  whitespace-nowrap">Email</th>
                        <th className=" p-1.5 text-start text-xs font-medium text-gray-600 bg-gray-50 border-b border-gray-200  whitespace-nowrap">Status</th>
                        <th className=" p-1.5 text-start text-xs font-medium text-gray-600 bg-gray-50 border-b border-gray-200  whitespace-nowrap">Created At</th>
                        <th className=" p-1.5 text-start text-xs font-medium text-gray-600 bg-gray-50 border-b border-gray-200 whitespace-nowrap">Updated At</th>
                        {(checkPermission('Admin Management', 'edit') || checkPermission('Admin Management', 'delete')) && (
                          <th className=" p-1.5 text-start text-xs font-medium text-gray-600 bg-gray-50 border-b border-gray-200  whitespace-nowrap">Actions</th>
                        )}
                      </tr>
                    </thead>
                    <tbody>
                      {filteredAdmins.map((admin, index) => (
                        ...
                        >
                          <td className=" p-1.5 text-start text-sm text-gray-600 border-b border-gray-100 whitespace-nowrap">{index + 1}</td>
                          <td className=" p-1.5 text-start text-sm text-gray-600 border-b border-gray-100 whitespace-nowrap">{admin.firstname}</td>
                          <td className=" p-1.5 text-start text-sm text-gray-600 border-b border-gray-100 whitespace-nowrap">{admin.lastname}</td>
                          <td className=" p-1.5 text-start text-sm text-gray-600 border-b border-gray-100 whitespace-nowrap">{admin.phoneNumber}</td>
                          <td className=" p-1.5 text-start text-sm text-gray-600 border-b border-gray-100 whitespace-nowrap">{admin.username}</td>
                          <td className=" p-1.5 text-start text-sm text-gray-600 border-b border-gray-100 whitespace-nowrap">{admin.email}</td>
                          <td className={` p-1.5 text-start text-sm border-b border-gray-100 whitespace-nowrap`}>
                          ...
                          <td className=" p-1.5 text-start text-sm text-gray-600 border-b border-gray-100 whitespace-nowrap">
